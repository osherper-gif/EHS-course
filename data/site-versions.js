window.SITE_VERSIONS = [
  ...
  },
  {
    ...
    "time": "לא צוין",
    "commitHash": "",
    "commitMessage": "chore: public readiness review for free access",
    "createdBy": "Osher Perets",
    "addedRequirements": "בדיקת השלמה לקראת פתיחה רחבה לציבור בשימוש חינמי, ללא דרישה לתשלום.",
    "siteChanges": "אומתו דפי המדיניות, קישורי הפוטר, קישורי המפה וההתאמות הבסיסיות לשימוש ציבורי ברור.",
    "fixedBugs": "נוקו ניסוחים טכניים גלויים ושופרה עקביות הקישורים לפוטר ולמידע על האתר.",
    "uiUxChanges": "חוזקו קישורי נגישות, מדיניות וקצת עליי בפוטר כדי לאפשר התמצאות קלה יותר למשתמשים.",
    "securityChanges": "לא בוצע שינוי במנגנון הכניסה או בהרשאות; דפי ניהול וכניסה נשארים מחוץ לקידום ציבורי.",
    "contentChanges": "עודכנה מדיניות הפרטיות כך שתכלול גם דיווחים ודירוגים על שאלות כחלק משיפור איכות האתר.",
    "firebaseChanges": "ללא שינוי במודל המשתמשים או בהרשאות המערכת.",
    "releaseNotes": "בדיקת מוכנות ציבורית לשימוש חינמי: נגישות, מדיניות, פוטר אחיד, שפה ידידותית ובדיקות בסיסיות לפני פתיחה רחבה.",
    "status": "published",
    "emailStatus": "notSent"
  },
  {
  ...
  },
  {
    ...
    "versionNumber": "Login Loading Improvement",
    "date": "2026-05-03",
    "time": "לא צוין",
    "commitHash": "",
    "commitMessage": "improve login loading after user interaction",
    "createdBy": "Osher Perets",
    ...
    "firebaseChanges": "שינוי פנימי במסלול טעינת ההתחברות לאחר פעולת משתמש בלבד.",
    "releaseNotes": "דף הכניסה קל יותר בטעינה הראשונית, ותהליך הכניסה נפתח רק כאשר המשתמש מבקש להתחבר.",
    "status": "published",
    "emailStatus": "notSent"
  },
  {
  ...
  },
  {
    ...
    "createdBy": "Osher Perets",
    "addedRequirements": "סריקת חומרי קורס חדשים, שילוב סיכומי Word, חידודי חוק/פקודה/תקנות, עדכון מאגר שאלות והוספת מנגנון מה חדש מאז הכניסה האחרונה.",
    "siteChanges": "עודכנו שיעורים ותוכן לימודי, הורחב מאגר השאלות, ונוסף מנגנון להצגת עדכונים אחרונים למשתמש.",
    "fixedBugs": "שופרו שאלות חזרה ונוספו שאלות ייעודיות לפי שיעור כדי להפחית שאלות כלליות או חוזרות.",
    "uiUxChanges": "נוספה בחירת רמת קושי במשחק, הצגת רמת קושי פעילה והמלצות המשך בהתאם לתוצאות המשתמש.",
    "securityChanges": "לא בוצע שינוי במבנה ההרשאות. שמירת מצב המשתמש נשענת על שמירה במכשיר ועל סנכרון רק כאשר הדבר זמין.",
    "contentChanges": "נוספו חידודי חוק, פקודה ותקנות, שאלות תרחיש, ושדות sourceNote לנושאים המחייבים אימות מול מקור עדכני.",
    "firebaseChanges": "נוסף שימוש אופציונלי בשדה lastSeenVersionAt לצורך הצגת עדכונים חדשים, עם fallback לשמירה במכשיר.",
    "releaseNotes": "רענון תוכן ושאלות לצד שיפור המשחק: שאלות קשות יותר, רמות קושי, ושיפור מנגנון עדכונים למשתמשים חוזרים.",
    "status": "published",
    "emailStatus": "notSent"
  },
  {
