(function () {
  ...
  const sessions = [
    ...
    session(2, "בעיות יסוד במערך הבטיחות הפנימי בארגון", ["human-factors"], { domain: "יסודות הבטיחות" }),
    session(3, "אחריות משפטית, תפקידים, סמכויות, קציני בטיחות, נאמן, מבצע, מנהל, יזם, העסקת קבלני כוח אדם, קבלני משנה, אחריות נזיקית ומשפטית", ["labor-inspection-law","safety-ordinance","human-factors"], { domain: "אחריות משפטית ובעלי תפקידים", examFocus: true }),
    session(4, "חוק ארגון הפיקוח על העבודה, מוסדות הבטיחות", ["labor-inspection-law"], { domain: "חקיקה ורגולציה", prepHref: "prep/lesson-03-labor-inspection-law.html", summary: { status: "available", href: "summaries/lesson-03-summary.html" }, examFocus: true }),
    session(5, "תקנות ארגון הפיקוח על העבודה (ממונים על הבטיחות), הוראות לממונה בטיחות", ["labor-inspection-law"], { domain: "חקיקה ורגולציה", examFocus: true }),
    session(6, "אחריות משפטית של ממונה בטיחות", ["labor-inspection-law","safety-ordinance"], { domain: "אחריות משפטית ובעלי תפקידים", examFocus: true }),
