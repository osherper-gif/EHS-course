(function () {
  ...
  const sessions = [
    ...
    session(12, "גידור מכונות, ריתוך, סקרי סיכונים במכונות, מבוא לתהליכי עיבוד שבבי", ["machine-guarding","safety-ordinance","loto-ptw"], { domain: "מכונות וגידור", examFocus: true, checklists: ["checklists.html?domain=Machine%20Guarding","checklists.html?domain=LOTO","checklists.html?domain=Risk%20Assessment"] }),
